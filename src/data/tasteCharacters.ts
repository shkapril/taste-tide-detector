...
export const tasteCharacters: TasteCharacter[] = [
  ...
  },
  {
    ...
    idealScores: { sweet: 40, sour: 70, rich: 50, bitter: 10, salty: 40, spicy: 90, umami: 60 },
  },
  {
    name: 'Mexico',
    emoji: '🇲🇽',
  ...
  },
  {
    name: 'Philippines',
    emoji: '🇵🇭',
    description: 'Bright sourness, bold salt, and gentle heat — tropical, savory, and lively.',
    idealScores: { sweet: 30, sour: 70, rich: 50, bitter: 10, salty: 80, spicy: 60, umami: 60 },
  },
  {
    name: 'Greece',
    emoji: '🇬🇷',
