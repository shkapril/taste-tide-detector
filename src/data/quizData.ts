...
export const sweetItems: QuizItem[] = [
  ...
  },
  {
    ...
    optionB: { name: 'Carrot Cake', image: 'https://images.unsplash.com/photo-1621303837174-89787a7d4729?w=600&h=600&fit=crop' },
    intensityA: 6,
    intensityB: 5,
    dietary: ['vegetarian', 'pescatarian', 'all-good'],
  },
  {
    ...
    optionB: { name: 'Cheesecake', image: 'https://images.unsplash.com/photo-1533134242443-d4fd215305ad?w=600&h=600&fit=crop' },
    intensityA: 8,
    intensityB: 6,
    dietary: ['vegetarian', 'pescatarian', 'all-good'],
  },
  {
    id: 'sweet-5',
    optionA: { name: 'Cotton Candy', image: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600&h=600&fit=crop' },
    optionB: { name: 'Caramel', image: 'https://images.unsplash.com/photo-1582716401301-b2407dc7563d?w=600&h=600&fit=crop' },
    intensityA: 10,
    intensityB: 6,
    dietary: ['vegan', 'vegetarian', 'pescatarian', 'all-good'],
  },
  ...
  {
    id: 'sweet-12',
    optionA: { name: 'White Chocolate', image: 'https://images.unsplash.com/photo-1548907040-4baa42d10919?w=600&h=600&fit=crop' },
